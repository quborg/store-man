...
export default class BagCard extends Component {
  ...
  render() {
    const [{name, volume, selected, onClick, _class},{image}] = [this.props,this.state]
      ...
      <div {...{onClick}} className={`item-card mb-30 fx fx-ac pointer ${_class} ${selected?'selected':''}`} >
        ...
        <div className='txt pl-2'>
          <div className="fx fx-ac fx-jc h-75 w-100">
            <div className='fx fx-ab'>
              <span className='nbr b font-3xl'>{volume}</span>
